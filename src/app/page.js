    ...
    <main>
      <div className="homePage" id="homePage">
        ...
        <div className="scrooldiv">
          <p>
            Scroll<HiArrowSmallDown></HiArrowSmallDown>
          </p>
        </div>
      </div>
      ...
      <div className="aboutPage" id="aboutPage">
        <div className="aboutMain">
          ...
          <div className="blockAbout">
            ...
            ></Image>
            <div>
              <Link href={'cv/cv_annie_tran.pdf'} target="_blank">
                RESUME
              </Link>
              <Link
              ...
              <Link href={'https://bento.me/annie-tran'} target="_blank">
                BENTO
              </Link>
            </div>
          </div>
        ...
        <div className="footerAboot">
          <Link href={'mailto:annietth.pro@gmail.com'}>
            ACCEPTING PROJECT FOR 2024
          </Link>
          <Link href={'https://www.malt.fr/profile/annietran'} target="_blank">
            LOOKING FOR JOBS
          </Link>
        </div>
      </div>
