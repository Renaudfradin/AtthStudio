  ...
  return (
    <>
      <div className="experienceTab">
        ...
        <ul>
          <li className="experienceLink">
            Product Designer at Supermood <br />
            2023-2024
          </li>
          <li className="experienceLink">
            Product Designer at Agily <br />
            2022-2023
          </li>
          <li className="experienceLink">
            Develop Web at Publicis Group <br />
            2020-2022
          </li>
          <li className="experienceLink">
            Develop Web & Lead Design at Docndoc <br />
            06/2020-09/2020
          </li>
        </ul>
      </div>
      <div className="degreeTab">
        <h3>Degree</h3>
        <ul>
          <li className="degreeLink">
            THREE.JS JOURNEY BRUNO SIMON <br />
            2024
          </li>
          <li className="degreeLink">
            CDO-PRODUCT DESIGN EEMI <br />
            2022-2024
          </li>
          <li className="degreeLink">
            Web developer HETIC <br />
            2019-2022
          </li>
        </ul>
      </div>
