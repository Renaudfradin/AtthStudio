    ...
    <div className="mainSupermmod">
      ...
      <div className="sectionSupermmod">
        <div className="sectionSaas">
          <div>
            ...
            <p className={`${criteria.className} titleDescription`}>
              Supermood, la solution de feedback instantané simple et efficace,
              partagée dans toute l’entreprise
            </p>
          </div>
        ...
        <div className="sectionMission">
          <div className="titleBlock">
            <h4 className={`${criteria.className} titleSupermood`}>
              Missions <br /> DESIGN SYSTEM
            </h4>
            <p>
              En tant que product designer, j’utilise la méthodologie de
              l’Atomic Design pour structurer et créer des systèmes d’interface
              utilisateur efficaces et cohérents. J’ai travaillé en
              collaboration avec les développeurs afin de créer un design system
              pertinent et intuitif pour avoir une cohésion entre-nous. J’ai
              designé de A à Z, soit de l’atome au prototypage.
            </p>
          </div>
        </div>
        <div className="sectionMission1">
          <div className="titleBlock">
            <h4 className={`${criteria.className} titleSupermood`}>
              Missions <br /> DESIGN SYSTEM ROKIT
            </h4>
            <p>
              Nous nous sommes inspirés de Material UI pour créer notre propre
              documentation sur Rokit. Pour cela, nous avons réalisé l’anatomie
              des composants de type (button, input, select, checkbox, tooltips,
              tips) en énumérant leurs variations et en prototypant les moments
              où l’élément se déclenche. Participation active et réalisation de
              nombreux composants.
            </p>
          </div>
        ...
        <div className="sectionMission2">
          <div className="titleBlock">
            <h4 className={`${criteria.className} titleSupermood`}>
              Missions <br /> Déclinaison des fonctionnalités
            </h4>
            <p>
              Notre objectif est d’améliorer constamment la plateforme en
              augmentant ses fonctionnalités et en rendant le travail plus
              accessible. Après des sessions de brainstorming avec les PM, PO et
              les product designers, nous nous occupons de toutes les
              ...
              pour que chaque développeur puisse les implémenter. Je m’assure de
              suivre les principes de conception, tels que la règle des 8, la
              loi de proximité et l’utilisation de design tokens. Mon but est de
              rendre le prototypage fluide et compréhensible pour les
              développeurs.
            </p>
          </div>
        ...
        <div className="sectionMission4">
          <div className="titleBlock">
            <h4 className={`${criteria.className} titleSupermood`}>
              Missions <br /> Challenger le layout
            </h4>
            <p>
              ...
              Scapin. Ensuite, j’établis une réunion avec les CX, PM et PO, ceux
              qui ont travaillé plusieurs fois sur la plateforme, pour que nous
              soulignions tous les problèmes ou accroches que les utilisateurs
              ont avec la plateforme. Ensuite, je réalise une matrice de valeurs
              pour émettre plusieurs hypothèses possibles.
            </p>
          </div>
        ...
        <div className="sectionMission5">
          <div className="titleBlock">
            ...
            <p>
              ...
              lectures. À chaque finalité de mon travail, je réalise un test A/B
              pour visualiser ce que les utilisateurs comprennent et ce qu’ils
              ne comprennent pas. Bien entendu, avant de réaliser, je demande
              une confirmation à mon lead designer. Malheureusement, je ne peux
              pas vous montrer le travail final, car il n’est pas encore
              disponible sur la plateforme.
            </p>
          </div>
          <div className="wrapImg5">
            <Image src={graph1} alt="imggraph1" />
            <Image src={graph2} alt="imggraph1" />
            <Image src={graph3} alt="imggraph1" />
          </div>
        </div>
        <div className="sectionMission6">
          <div className="titleBlock">
            <h4 className={`${criteria.className} titleSupermood`}>
              Missions <br /> Branding sur les emails
            </h4>
            <p>
              Il m’est arrivé aussi de réaliser des missions qui sortent de mon
              travail de produit et de me concentrer sur l’aura de l’entreprise.
              En effet, l’image de Supermood se doit d’être éthique avec nos
              valeurs. Nous sommes Supermood, une entreprise dans laquelle
              l’humain est au centre. Il est donc primordial de réaliser un
              mini-branding.
            </p>
          </div>
          <div className="wrapImg6">
            <Image src={email1} alt="imgEmail1" />
            <Image src={email2} alt="imgEmail2" />
            <Image src={email3} alt="imgEmail3" />
          </div>
        </div>
        <div className="sectionMission7">
          <div className="titleBlock">
            <h4 className={`${criteria.className} titleSupermood`}>
              Missions <br /> Branding sur les meetings
            </h4>
            <p>
              Il m’est arrivé aussi de réaliser des missions qui sortent de mon
              travail de produit et de me concentrer sur l’aura de l’entreprise.
          ...
          <div className="wrapImg7">
            <Image src={meet1} alt="imgMeet1" />
            <Image src={meet2} alt="imgMeet2" />
            <Image src={meet3} alt="imgMeet3" />
          </div>
        </div>
