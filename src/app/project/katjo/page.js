        ...
        <div className="content">
          ...
          <div className="pitch">
            <div className="pitchcontent">
              <h5>Pitch</h5>
              <p>
                Imagine the future collaborative application of Paris 2024,
                centered on users (transport, tickets, activities, Olympic
                sites, connectivity, etc.)
              </p>
              <h5>Duration</h5>
              <p>10 weeks</p>
            </div>
          ...
          <Image className="ojectifImg" src={object} alt="ojectif"></Image>
          ...
          <div className="sprint">
            <Image src={sprint1} alt="Sprint 1"></Image>
            <Image src={sprint2} alt="Sprint 2"></Image>
            <Image src={sprint3} alt="Sprint 3"></Image>
            <Image src={sprint4} alt="Sprint 4"></Image>
          </div>
          <h3 className="titleDesign">Concept</h3>
          <div className="concept">
            <h4>KatJO</h4>
            <Image className="conceptImg" src={concept} alt="concept"></Image>
          </div>
          <h3 className="titleDesign">Wireframe</h3>
          <div className="wireframe">
            <Image src={billet} alt="billet"></Image>
            <Image src={conseil1} alt="conseil 1"></Image>
            <Image src={conseil2} alt="conseil 2"></Image>
            <Image src={conseil3} alt="conseil 3"></Image>
          </div>
          <h3 className="titleDesign">Design</h3>
          <Image className="imgDesign" src={design} alt="design"></Image>
          <Image
