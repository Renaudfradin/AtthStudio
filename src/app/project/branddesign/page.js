        ...
        <div className='sectionBrandMain'>
          <div>
            ...
            <div className='sectionTypography'>
              ...
              ></Image>
              <div>
                <p className='typoManroque'>There are 2 different typographies on this logo</p>
                <p className={`${dTRandom.className} typoDT`}>DT random Display</p>
                <p className={`${letterMagic.className} typoLMagique`}>Letter magic</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className='sectionProcessus'>
              ...
              <Image
                ...
                alt='imgT'
              ></Image>
              <p>I took my initial name I added with the initials of my 2nd name</p>
              <Image
                src={h}
                alt='imgH'
              ></Image>
              <p>Having 2 letter T, I played with it ! H is one of my creations</p>
            </div>
          </div>
          <div>
            ...
            <div className='sectionLogo'>
              <Image
                ...
                alt='imgDegree'
              ></Image>
              <p>I played with the thickness of the letters and the pixelation of them I adjusted the spacing to 20px</p>
            </div>
          </div>
          <div>
