  ...
  return (
    <div className="main">
      ...
      <div className="section">
        ...
        <h3 className="titleDesignMobile">
          Achetez en confiance, vendez rapidemant
        </h3>
        <Image
        ...
        <div className="content">
          <h3 className="titleDesign1">
            Achetez en confiance, vendez rapidement
          </h3>
          ...
          <div className="pitch">
            <div className="pitchcontent">
              <h5>Pitch</h5>
              <p>
                Découvrez la nouvelle de l’immobilier 2.0. Nous vous offrons une
                expérience transparente, efficace et sécurisée, mettant en
                relation vendeurs et acheteurs de biens immobiliers
              </p>
              <h5>Duration</h5>
              <p>1 week</p>
            </div>
          ...
          <div className="objectifHestia">
            <div>
              ...
              <p className="detailObjectifHestia">
                Nous sélectionnons pour vous les meilleurs candidats pour vos
                bien!
              </p>
            </div>
            <div>
              ...
              <p className="detailObjectifHestia">
                Sélectionner le motif de votre préférence tous les mois pour vos
                couches.
              </p>
            </div>
            <div>
              ...
              <p className="detailObjectifHestia">
                Nous mettons en relations des profils qui vous conviennent.
              </p>
            </div>
          </div>
